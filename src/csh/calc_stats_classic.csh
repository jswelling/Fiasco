...
#
echo '#'`date` $0
echo '# $Id: calc_stats_classic.csh,v 1.4 2003/09/09 16:18:10 bakalj Exp $'
...
#
# compute means, variances within conditions and t's between conditions
stat.csh $data
...
#
# If environment variables are set indicating that the user wants
# Pmaps, generate them.
if ( ${?F_LOWERP} || ${?F_UPPERP} || ${?F_LOWERQ} ) then
  pmaps.csh 
endif
