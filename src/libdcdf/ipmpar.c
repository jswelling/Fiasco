...
/*
   ...
   imach[10] = 127;
*/
/*     Since we have LAPACK, let's do this portably */
  if ( imach[1]==0 ) {
    /* Not yet initialized */
    imach[1]= (int)SLAMCH("B");
    imach[2]= CHAR_BIT*sizeof(int)-1;
    imach[3]= INT_MAX;
    imach[4]= imach[1];
    imach[5]= (int)SLAMCH("N");
    imach[6]= (int)SLAMCH("M");
    imach[7]= (int)SLAMCH("L");
    imach[8]= (int)DLAMCH("N");
    imach[9]= (int)DLAMCH("M");
    imach[10]= (int)DLAMCH("L");
  }
  ipmpar = imach[*i];
  return ipmpar;
}
