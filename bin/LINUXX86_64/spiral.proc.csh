...
# ************************************************************/
#
# $Id: spiral.proc.csh,v 1.8 2007/06/21 23:13:20 welling Exp $
echo '#'`date` $0
if(! -e fiasco.local.csh) cp $FIASCO/fiasco.local.csh .
source fiasco.local.csh
if (-e spiral.defaults.csh) then
  source spiral.defaults.csh
else
  source $FIASCO/spiral.defaults.csh
endif
if(! -e spiral.local.csh) cp $FIASCO/spiral.local.csh .
source spiral.local.csh
...
set rawScriptName = spiral.steps.csh
