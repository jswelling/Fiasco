 ...
 *                                                          *
 *                                                          *
 *  Original programming by Joel Welling 1/2004             *
 ************************************************************/
/* Header file for closest_warp.c */

/* Switches to be passed to setflag and getflag */
#define CLWARP_DEBUG 0

/* Entry points for getting and setting linwarp switches */
void clwarp_set(int, int);
int clwarp_get(int);
