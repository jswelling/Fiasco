...
# ************************************************************/
#
echo '#$Id: epi.defaults.csh,v 1.54 2007/06/15 18:10:51 welling Exp $'
if(! -d in)mkdir in
#
#
# if the following variables have not already been specified, set them here
if (! $?F_TEMP)		setenv F_TEMP		/tmp
if (! $?F_DIR)		setenv F_DIR		$FIASCO/../../epidata/
...
#
# input data space (k for k-space, i for image space).  At this point
# the scripts are smart enough that this value is generally not needed.
...
#
# vector length (2 for epi k-space)
...
# ramp_resample.csh
#
setenv F_RESAMP_OUTPUT resample
...
setenv F_MEANC_PARMS	meanc3d.par
#
# fixed image number
@ F_N2 = $F_NIMAGE / 2
...
#
# width of output image
setenv F_CLIP2_WIDTH	64
#
# height of output image
setenv F_CLIP2_HEIGHT	64
#
# location of center in x direction
setenv F_CLIP2_XCENTER	center
#
# location of center in y direction
setenv F_CLIP2_YCENTER	32
#
#
# outlier.csh
#
...
#
# short description
setenv F_DESCRIPTION	"EPI TEST DATA SET"
